...
@section('content')
      ...
      <div class="grid grid-cols-2 gap-[30px]">
        <div class="p-[50px] pb-0 rounded-[30px] flex flex-col gap-[50px] bg-[#F4F5F8]">
          ...
          <div class="flex flex-col gap-5">
            ...
            <p class="text-lg leading-[34px]">Delivering great experience to users so that they are comfortable while
          ...
          <div
            ...
            <div
              ...
              <div class="z-10 text-center">
                <p class="font-extrabold text-[32px] leading-[48px] mb-[10px] text-white">AI Finance SaaS <br>Website
                  Integrations</p>
              ...
              <a href="details.html"
                ...
                Details</a>
              <img src="../assets/images/Ellipse.svg"
                class="absolute w-1/2 transform -translate-x-1/2 -translate-y-1/2 left-1/2 top-1/2"
                alt="background icon">
            </div>
          </div>
          <div
  ...
  <section id="Testimonials" class="bg-[#F4F5F8]">
    <div class="container max-w-[1130px] mx-auto pt-[180px] pb-[100px]">
      <h2 class="font-extrabold text-[50px] leading-[70px] text-center">I Have Delivered Success <br>For All My Clients
      </h2>
      ...
      <div class="flex flex-col gap-[30px] w-[603px] shrink-0">
        <div class="flex flex-col p-5 rounded-2xl bg-[#F4F5F8] w-full">
          <button class="flex items-center justify-between gap-1 accordion-button" data-accordion="accordion-faq-1">
            ...
            <div class="flex arrow w-9 h-9 shrink-0">
              <img src="../assets/images/icons/arrow-circle-down.svg" class="transition-all duration-300"
                alt="icon">
            </div>
          </button>
        ...
        <div class="flex flex-col p-5 rounded-2xl bg-[#F4F5F8] w-full">
          ...
          <div id="accordion-faq-2" class="accordion-content hide">
            <p class="text-[20px] leading-[36px] pt-5">I don’t charge hourly. I charge based on the project brief and
              given timeline to finish that particular project.</p>
          </div>
        </div>
        <div class="flex flex-col p-5 rounded-2xl bg-[#F4F5F8] w-full">
    ...
    <div
      ...
      <div class="flex gap-[100px] z-10">
        <div class="flex flex-col gap-5">
          ...
          <a href=""
            class="font-medium transition-all duration-300 hover:font-semibold hover:text-portto-light-gold">Services</a>
          <a href=""
            class="font-medium transition-all duration-300 hover:font-semibold hover:text-portto-light-gold">Testimonials</a>
          <a href=""
            class="font-medium transition-all duration-300 hover:font-semibold hover:text-portto-light-gold">Pricing</a>
          <a href=""
            class="font-medium transition-all duration-300 hover:font-semibold hover:text-portto-light-gold">About</a>
        </div>
        <div class="flex flex-col gap-5">
          <p class="text-lg font-bold">Services</p>
          <a href=""
            class="font-medium transition-all duration-300 hover:font-semibold hover:text-portto-light-gold">UI/UX
            Design</a>
          <a href=""
            class="font-medium transition-all duration-300 hover:font-semibold hover:text-portto-light-gold">Web
            Development</a>
          <a href=""
            class="font-medium transition-all duration-300 hover:font-semibold hover:text-portto-light-gold">Data
            Science</a>
          <a href=""
            class="font-medium transition-all duration-300 hover:font-semibold hover:text-portto-light-gold">Digital
            Marketing</a>
        </div>
        <div class="flex flex-col gap-5">
          <p class="text-lg font-bold">About</p>
          <a href=""
            class="font-medium transition-all duration-300 hover:font-semibold hover:text-portto-light-gold">My
            Profile</a>
          <a href=""
            class="font-medium transition-all duration-300 hover:font-semibold hover:text-portto-light-gold">How do I
            work</a>
          <a href=""
            class="font-medium transition-all duration-300 hover:font-semibold hover:text-portto-light-gold">Achievements</a>
          <a href=""
            class="font-medium transition-all duration-300 hover:font-semibold hover:text-portto-light-gold">Team A</a>
        </div>
        <div class="flex flex-col gap-5">
