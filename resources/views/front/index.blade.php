      ...
      <div class="grid grid-cols-2 gap-[30px]">
        <div class="p-[50px] pb-0 rounded-[30px] flex flex-col gap-[50px] bg-[#F4F5F8]">
          <div class="flex items-center justify-center w-20 h-20 rounded-full shrink-0 bg-portto-purple">
            <img src="{{ asset('/images/icons/crown.svg') }}" class="object-contain w-10 h-10" alt="icon">
          </div>
          ...
          <div class="w-full h-[350px]">
            <img src="{{ asset('/images/services1.png') }}" class="object-contain w-full" alt="image">
          </div>
        </div>
        <div class="p-[50px] pb-0 rounded-[30px] flex flex-col gap-[50px] bg-[#F4F5F8]">
          <div class="flex items-center justify-center w-20 h-20 rounded-full shrink-0 bg-portto-green">
            <img src="{{ asset('/images/icons/code.svg') }}" class="object-contain w-10 h-10" alt="icon">
          </div>
          <div class="flex flex-col gap-5">
          ...
          <div class="w-full h-[350px]">
            <img src="{{ asset('/images/services2.png') }}" class="object-contain w-full" alt="image">
          </div>
        </div>
        <div class="col-span-2 p-[50px] pb-0 rounded-[30px] flex gap-[50px] bg-[#F4F5F8]">
          <div class="flex flex-col gap-[50px]">
            <div class="flex items-center justify-center w-20 h-20 rounded-full shrink-0 bg-portto-red">
              <img src="{{ asset('/images/icons/3dcube.svg') }}" class="object-contain w-10 h-10" alt="icon">
            </div>
            <div class="flex flex-col gap-5">
          ...
          <div class="w-[450px] h-[350px] flex shrink-0">
            <img src="{{ asset('/images/services3.png') }}" class="object-contain w-full" alt="image">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="flex items-center group/slider slider flex-nowrap w-max">
        <div
          ...
          <div
            class="group w-[650px] h-[450px] flex shrink-0 rounded-[30px] border border-white p-5 bg-[#FFFFFF33] backdrop-blur relative">
            <div class="w-[608px] h-[408px] rounded-[30px] overflow-hidden absolute">
              <img src="{{ asset('/images/thumbnails/thumbnail2.png') }}" class="object-cover w-full h-full"
                alt="thumbnail">
            </div>
            <div
              class="flex flex-col w-full items-center justify-center gap-[50px] bg-portto-black rounded-[30px] relative opacity-0 hover:opacity-100 transition-all duration-300">
