  ...
  <section id="Content" class="flex min-h-screen bg-portto-black">
    <div
      ...
      <div class="flex flex-col bg-white p-[30px] gap-5 rounded-[30px] w-[580px]">
        ...
        <p class="font-semibold text-[22px] leading-[40px]">She helped us to build our first prototype to win our investor
          and early users heart that generate huge attraction.</p>
